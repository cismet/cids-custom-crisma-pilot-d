 ...
 */
public class RoadImpactMiniatureView extends javax.swing.JPanel implements WorldstateContainer {

    //~ Instance fields --------------------------------------------------------

    private transient CidsBean worldstate;

    private final transient Logger LOG = LoggerFactory.getLogger(RoadImpactMiniatureView.class);
     ...
     */
    public RoadImpactMiniatureView() {
        initComponents();
    }
