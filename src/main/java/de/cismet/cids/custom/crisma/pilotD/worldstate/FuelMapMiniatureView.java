 ...
 */
public class FuelMapMiniatureView extends javax.swing.JPanel implements WorldstateContainer {

    //~ Instance fields --------------------------------------------------------

    private transient CidsBean worldstate;

    private final transient Logger LOG = LoggerFactory.getLogger(FuelMapMiniatureView.class);
    ...
    private void init() {
        try {
            ShakemapView.initPilotDMap(mappingComponent1, "fuel_map", worldstate, 0.8f, new WFSRequestListener());
            mappingComponent1.setInteractionMode("MUTE");
        } catch (final Exception e) {
            LOG.error("cannot initialise fuel map miniature view", e);
