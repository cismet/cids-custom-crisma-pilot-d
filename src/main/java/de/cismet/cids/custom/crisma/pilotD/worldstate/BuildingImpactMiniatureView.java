 ...
 */
public class BuildingImpactMiniatureView extends javax.swing.JPanel implements WorldstateContainer {

    //~ Instance fields --------------------------------------------------------

    private transient CidsBean worldstate;

    private final transient Logger LOG = LoggerFactory.getLogger(BuildingImpactMiniatureView.class);
     ...
     */
    public BuildingImpactMiniatureView() {
        initComponents();
    }
    ...
    private void init() {
        try {
            ShakemapView.initPilotDMap(mappingComponent1, "buildImpact", worldstate, 0.8f, new WFSRequestListener());
